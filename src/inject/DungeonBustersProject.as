package
{
   ...
   public class DungeonBustersProject extends GameEntry
   {
      ...
      public function DungeonBustersProject()
      {
         ...
         // --- MOD ENGINE TEST BAŞLANGICI ---
         trace("MOD ENGINE: Inject islemi basarili! Trace logu.");
         try {
             // Oyunun kendi logger'ını kullanarak hata mesajı gibi gösteriyoruz ki dikkat çeksin
             Logger.error("MOD ENGINE: Inject islemi basarili! Oyun ici Logger.");
         } catch(e:Error) {
             trace("Logger bulunamadi ama kod calisiyor.");
         }
         // --- MOD ENGINE TEST BİTİŞİ ---
      ...
      private function processArguments(param1:Array) : void
      {
         var _loc3_:int = 0;
         var _loc2_:String = null;
